...
function doTheRun(method, thread_count, partition_count) {
    return __awaiter(this, void 0, void 0, function () {
        var regex, processOutput, matches, results, next, parsedValue;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    regex = /(?<value>(?:\d|\.)+)(?:\s{6})(?<name>\S+)/gm;
                ...
                case 1:
                    ...
                    matches = processOutput.matchAll(regex);
                    results = [];
                    for (next = matches.next(); next.value; next = matches.next()) {
                        parsedValue = Number(next.value[1].replaceAll(".", ""));
